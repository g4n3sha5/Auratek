...
const IconBox = ({ name, desc, icon }) => {
  return (
    <div
      className="icon-box mt-5 mt-lg-0 mb-4"
      data-aos="zoom-in"
      data-aos-delay="150"
    >
      <i className={icon}></i>
        ...
        <div className="container p-3 px-5 ">
          ...
          <div className="row">
            <div className=" col-lg-6 descriptions pt-4">
              <p>
                Jesteśmy dynamicznym przedsiębiorstwem prywatnym, które od 2008
                roku działa na rynku branży instalacyjnej. Nasza firma
                specjalizuje się w kompleksowych rozwiązaniach z zakresu
                wewnętrznych instalacji sanitarnych oraz nadzoruje realizację
                różnorodnych przedsięwzięć budowlanych.
              </p>
              <p>
                Dzięki naszemu doświadczeniu i profesjonalizmowi, wykonujemy
                projekty na obiektach przemysłowych oraz w sektorze użyteczności
                publicznej. Niezależnie od skali i złożoności projektu,
                zapewniamy wysoką jakość usług na terenie Polski oraz za
                granicą.
              </p>
              <p>
                Jesteśmy gotowi podjąć wyzwania każdego projektu i dostarczyć
                rozwiązania, które spełnią oczekiwania naszych klientów. Dołącz
                do grona zadowolonych partnerów, którzy czerpią korzyści z
                naszej fachowej wiedzy i doświadczenia.
              </p>
            </div>
